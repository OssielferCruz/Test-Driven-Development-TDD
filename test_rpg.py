...
def test_curar_personaje():
    ...
    # Bajar la vida del heroe
    sanador.atacar(heroe, dano=200)  # HP queda en 800
...
def test_no_curar_mas_del_maximo():
    ...
    sanador.atacar(heroe, dano=100)  # HP queda en 900
    sanador.curar(heroe, cantidad=200)

    assert heroe.hp == 1000  # No debe pasar de 1000
...
def test_los_muertos_no_se_curan():
    ...
    enemigo.atacar(heroe, dano=1500)  # Heroe muere
